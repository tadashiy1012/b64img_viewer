...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxActions = __webpack_require__(190);
	...
	var _setPict = (0, _reduxActions.createAction)('SET_PICT');
	var _resetPict = (0, _reduxActions.createAction)('RESET_PICT');
	var reducer = (0, _reduxActions.handleActions)((_handleActions = {}, _defineProperty(_handleActions, _setPict, function (state, action) {
	  return Object.assign({}, state, {
	    picture: action.payload
	  });
	}), _defineProperty(_handleActions, _resetPict, function (state, action) {
	  return Object.assign({}, state, {
	    picture: ''
	  });
	}), _handleActions), {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
	  return {
	    setPict: function setPict() {
	      remote.require('./openFile')(function (resp) {
	        dispatch(_setPict(resp));
	      });
	    },
	    resetPict: function resetPict() {
	      dispatch(_resetPict());
	    }
	  };
	};
	
	var RApp = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(App);
	
	(0, _reactDom.render)(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store },
	  _react2.default.createElement(RApp, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(191);
	...
	var _handleActions = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(194);
	
	var _ownKeys2 = _interopRequireDefault(_ownKeys);
	
	var _reduceReducers = __webpack_require__(195);
